<?php include ('hod_server.php'); ?>
<html>
<head>
  <title></title>
  <h1 style=" color: white"><a href="dep_identity.php"><button class="btn2">←</button></a>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HOD &nbsp;Login&nbsp; Form</h1>
  <style type="text/css">
  .btn2{
    font-size: 30px;
...
<body>
  ...
  <button type="submit" class="btn" name="hod_sub">Log in</button> 
   </form>  
